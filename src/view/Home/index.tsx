...
const Home: React.FC = () => {
    ...
    const data = [
        ...
        {"id":2,"title":"Mens Casual Premium Slim Fit T-Shirts ","price":22.35,"description":"Slim-fitting style, contrast raglan long sleeve, three-button henley placket, light weight & soft fabric for breathable and comfortable wearing.","category":"men's clothing","image":"https://fakestoreapi.com/img/71-3HjGNDUL._AC_SY879._SX._UX._SY._UY_.jpg"},
  ...
  <Container>
      <section>
      <h1>Gama yard Sale</h1>
          { data.map( (prod, index) => (
              <div className="product-content" key={prod.id}>
              <img src={prod.image} width="100%" height="auto" alt={prod.title} />
              <h4>{prod.title}</h4>
